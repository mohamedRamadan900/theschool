...
import { StudentDirectoryComponent } from "./components/student-directory/student-directory.component";

@Component({
    selector: 'app-summary',
    imports: [SummaryStatsComponent, StackedBarChart, PieChartComponent, MapComponent, TableComponent, FilterPanelComponent, DashboardNavbarComponent, StudentsByYearGroupComponent, GenderRatioComponent, StudentDirectoryComponent],
    templateUrl: './summary.component.html',
    styleUrl: './summary.component.scss',
    providers: [SummaryService, { provide: SchoolDataAPIService, useClass: SchoolDataMockService }]
})
